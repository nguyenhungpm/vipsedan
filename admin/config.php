<?php
// HTTP
define('HTTP_SERVER', 'http://localhost:8080/quantri/admin/');
define('HTTP_CATALOG', 'http://localhost:8080/quantri/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost:8080/quantri/admin/');
...
define('DIR_CATALOG', 'C:/xampp/htdocs/quantri/catalog/');
